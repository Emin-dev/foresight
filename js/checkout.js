...
// test cards) work.
//
// What this unlocks: Islands 2 (Stonemarch) and 3 (Windkeep) — 10 more
// missions beyond the free 5-mission Reedshore island. Monetization model is
// BUY: one-time purchase, not a subscription.

const DECLINE_TEST_CARD = '4000000000000002';
const ONE_TIME_PRICE_USD = 4.99;
const STORAGE_KEY = 'foresight_unlocked_v1';
  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      if (isDeclineCard) {
        ...
        resolve({ ok: true, message: 'Stonemarch and Windkeep unlocked (sandbox).', reference });
      }
    }, 700);
  });
}
